...
namespace with_state
{
	...
	public:
		...
		virtual void Fill(unsigned ballsCount) = 0;
	...
	public:
		...
		virtual void IncreaseBallsCount(unsigned increaseOnCount) = 0;
	...
	public:
		...
		void Fill(unsigned ballsCount) override
		{
			std::cout << "Oops, can't fill machine while rolling the ball\n";
		}
	...
	public:
		...
		void Fill(unsigned ballsCount) override
		{
			m_gumballMachine.IncreaseBallsCount(ballsCount);
			std::cout << std::format("Balls count have been increased and now count is {}\n",
				m_gumballMachine.GetBallsCount());
	...
	public:
		...
		void Fill(unsigned ballsCount)
		{
			m_state->Fill(ballsCount);
		}
	...
	protected:
		...
		void IncreaseBallsCount(unsigned increaseOnCount)
		{
			m_ballsCount += increaseOnCount;
		}
